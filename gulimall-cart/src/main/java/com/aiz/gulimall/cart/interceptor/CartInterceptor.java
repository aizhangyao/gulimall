...
import static com.aiz.common.constant.CartConstant.TEMP_USER_COOKIE_NAME;
import static com.aiz.common.constant.CartConstant.TEMP_USER_COOKIE_TIMEOUT;

/**
 * @ClassName CartInterceptor
 * @Description 在执行目标方法之前，判断用户的登录状态.并封装传递给controller目标请求
 * @Author ZhangYao
 * @Date Create in 23:16 2022/10/13
 * @Version 1.0
 */
