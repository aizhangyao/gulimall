...
/**
 * @ClassName GulimallOrderRabbitMQTests
 * @Description TODO
 * @Author ZhangYao
 * @Date Create in 16:54 2022/10/14
 * @Version 1.0
 */
...
@SpringBootTest
public class GulimallOrderRabbitMQTests {
    @Autowired
    ...
    @Test
    public void sendManyMessageTest() {
        for (int i = 0; i < 10; i++) {
            if (i % 2 == 0) {
                OrderReturnReasonEntity reasonEntity = new OrderReturnReasonEntity();
                reasonEntity.setId(1L);
